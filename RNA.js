...
compute(list = []) {
 ...
 load(rna) {
    ...
    try {
        ...
        // 'catch (e)' vai ser usado para capturar e lidar com erros em JavaScript, permitindo que voçê tome decições específicas quando acontece uma exceção durante a execução do código.
        return;       
   }
 }
